...
const POST = async ({ request }) => {
  const apiKey = "re_P6i8dYoA_DvHoLcxVXFK7P1nsSvNjYNWq";
  ...
  try {
      ...
      <html>
        ...
        <body>
          ...
          <div class="content">
            ...
            <div class="footer">
              <p>This lead was submitted on ${(/* @__PURE__ */ new Date()).toLocaleString("en-US", {
      dateStyle: "full",
      timeStyle: "short",
    ...
    const { data: emailData, error } = await resend.emails.send({
      from: "HELOC Leads <leads@cliffmortgages.com>",
