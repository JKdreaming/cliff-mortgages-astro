import { c as createComponent, d as createAstro, m as maybeRenderHead, b as addAttribute, r as renderComponent, a as renderTemplate, F as Fragment } from './astro/server_DYAQuqF9.mjs';
import 'piccolore';

const homeHeroImage = new Proxy({"src":"/_astro/black-real-estate-agent-showing-property-to-her-cl-2024-12-13-22-29-55-utc.BpQz3tOv.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/black-real-estate-agent-showing-property-to-her-cl-2024-12-13-22-29-55-utc.jpg";
							}
...
const homeEquityBannerBackground = new Proxy({"src":"/_astro/Depositphotos_600595700_L.DAmbzcSO.jpg","width":1400,"height":836,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_600595700_L.jpg";
							}
...
const aboutHeroImage = new Proxy({"src":"/_astro/multiracial-team-of-architects-having-a-meeting-wh-2025-04-01-13-10-07-utc.D7j-4BE-.jpg","width":1400,"height":921,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/multiracial-team-of-architects-having-a-meeting-wh-2025-04-01-13-10-07-utc.jpg";
							}
...
const cindyHeroImage = new Proxy({"src":"/_astro/business-woman-handshake-and-applause-deal-with-s-2025-04-05-22-52-06-utc.B4VW0Om3.jpg","width":1200,"height":633,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/business-woman-handshake-and-applause-deal-with-s-2025-04-05-22-52-06-utc.jpg";
							}
...
const cindyPortraitImage = new Proxy({"src":"/_astro/laughing-brunette-elegant-woman-giving-pointers-t-2025-08-31-03-28-56-utc.Bni2Tsbz.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/laughing-brunette-elegant-woman-giving-pointers-t-2025-08-31-03-28-56-utc.jpg";
							}
...
const loanProgramsHeroImage = new Proxy({"src":"/_astro/vitaly-gariev-4_gR8nkzeuQ-unsplash.DzkUvibS.jpg","width":1200,"height":520,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/vitaly-gariev-4_gR8nkzeuQ-unsplash.jpg";
							}
...
const loanProgramsHeroPanelBackground = new Proxy({"src":"/_astro/exterior-design-of-a-modern-house-exterior-with-wa-2025-02-10-06-45-01-utc.igntl47Z.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/exterior-design-of-a-modern-house-exterior-with-wa-2025-02-10-06-45-01-utc.jpg";
							}
...
const loanProgramsEquityBackground = new Proxy({"src":"/_astro/portrait-of-a-young-couple-standing-outside-their-2025-04-05-13-10-04-utc.CnPVt5Iz.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/portrait-of-a-young-couple-standing-outside-their-2025-04-05-13-10-04-utc.jpg";
							}
...
const getQuoteHeroImage = new Proxy({"src":"/_astro/docusign-P9kDDB8APmE-unsplash.CxrQlUVO.jpg","width":1200,"height":1800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/docusign-P9kDDB8APmE-unsplash.jpg";
							}
...
const privacyHeroImage = new Proxy({"src":"/_astro/customers-who-choose-to-buy-a-condominium-room-and-2024-11-01-18-28-48-utc.C54PX5R5.jpg","width":1200,"height":755,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/customers-who-choose-to-buy-a-condominium-room-and-2024-11-01-18-28-48-utc.jpg";
							}
...
const accessibilityHeroImage = new Proxy({"src":"/_astro/portrait-of-senior-couple-standing-outside-front-d-2024-10-22-12-30-23-utc.DJjjX_4V.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/portrait-of-senior-couple-standing-outside-front-d-2024-10-22-12-30-23-utc.jpg";
							}
...
const disclosuresHeroImage = new Proxy({"src":"/_astro/architect-engineer-team-discusses-modern-house-mod-2025-03-08-14-31-58-utc.Cf6Bpmos.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/architect-engineer-team-discusses-modern-house-mod-2025-03-08-14-31-58-utc.jpg";
							}
...
const equitySelectProgramHeroImage = new Proxy({"src":"/_astro/senior-couple-holding-keys-and-standing-outside-th-2025-04-01-13-23-24-utc.ByyQjOxD.jpg","width":1400,"height":933,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/senior-couple-holding-keys-and-standing-outside-th-2025-04-01-13-23-24-utc.jpg";
							}
...
const equitySelectLandingHeroImage = new Proxy({"src":"/_astro/EquitySelect_Landing_Page_Hero_Image.BYrhKWKf.jpg","width":1400,"height":933,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/EquitySelect_Landing_Page_Hero_Image.jpg";
							}
...
const purchaseHeroImage = new Proxy({"src":"/_astro/family-with-cardboard-boxes-and-labrador-dog-stand-2024-11-19-07-47-21-utc.DqK32wOB.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/family-with-cardboard-boxes-and-labrador-dog-stand-2024-11-19-07-47-21-utc.jpg";
							}
...
const refinanceHeroImage = new Proxy({"src":"/_astro/smiling-mature-couple-embracing-in-garden-of-their-2024-09-19-01-31-00-utc.CDD5zI5A.jpg","width":1200,"height":801,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/smiling-mature-couple-embracing-in-garden-of-their-2024-09-19-01-31-00-utc.jpg";
							}
...
const helocHeroImage = new Proxy({"src":"/_astro/Depositphotos_587140642_L.C16ah0pg.jpg","width":1400,"height":934,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_587140642_L.jpg";
							}
...
const dscrHeroImage = new Proxy({"src":"/_astro/Depositphotos_607609090_L.WbMTumld.jpg","width":1400,"height":923,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_607609090_L.jpg";
							}
...
const vaHeroImage = new Proxy({"src":"/_astro/Depositphotos_511183850_L.Bma0tehX.jpg","width":1400,"height":933,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_511183850_L.jpg";
							}
...
const reverseMortgageHeroImage = new Proxy({"src":"/_astro/Depositphotos_60887993_L.CEVCuD2s.jpg","width":1400,"height":933,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_60887993_L.jpg";
							}
...
const jumboHeroImage = new Proxy({"src":"/_astro/Depositphotos_8716913_L.Aj8gFUM9.jpg","width":1400,"height":933,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_8716913_L.jpg";
							}
...
const usdaHeroImage = new Proxy({"src":"/_astro/Depositphotos_663082552_L.CZFUigUz.jpg","width":1400,"height":788,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_663082552_L.jpg";
							}
...
const commercialHeroImage = new Proxy({"src":"/_astro/Depositphotos_2561504_L.SnItgRpx.jpg","width":1400,"height":930,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Depositphotos_2561504_L.jpg";
							}
...
const conventionalHeroImage = new Proxy({"src":"/_astro/portrait-of-happy-caucasian-couple-sitting-on-terr-2025-04-04-05-17-17-utc.DxczoWuk.jpg","width":1400,"height":933,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/portrait-of-happy-caucasian-couple-sitting-on-terr-2025-04-04-05-17-17-utc.jpg";
							}
...
const fhaHeroImage = new Proxy({"src":"/_astro/young-happy-family-having-fun-on-sofa-in-bright-in-2024-10-16-17-43-16-utc.BHLYOB6x.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/young-happy-family-having-fun-on-sofa-in-bright-in-2024-10-16-17-43-16-utc.jpg";
							}
...
const constructionHeroImage = new Proxy({"src":"/_astro/a-construction-site-a-domestic-house-being-built-2025-04-04-08-31-53-utc.BIJXG2HC.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/a-construction-site-a-domestic-house-being-built-2025-04-04-08-31-53-utc.jpg";
							}
...
const fha203kHeroImage = new Proxy({"src":"/_astro/a-builder-sweeping-and-tidying-up-in-a-renovated-r-2025-04-04-00-29-21-utc.D_FvGLfL.jpg","width":1200,"height":863,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/a-builder-sweeping-and-tidying-up-in-a-renovated-r-2025-04-04-00-29-21-utc.jpg";
							}
...
const nonQmHeroImage = new Proxy({"src":"/_astro/portrait-of-successful-and-smiling-business-team-w-2025-01-10-04-29-07-utc.pkZ6nS11.jpg","width":1200,"height":800,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/portrait-of-successful-and-smiling-business-team-w-2025-01-10-04-29-07-utc.jpg";
							}
...
const equitySelectBannerBackground = new Proxy({"src":"/_astro/portrait-of-a-latin-family-with-afro-hair-with-a-7-2025-01-08-03-41-40-utc.CJCO7_iv.jpg","width":1200,"height":830,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/portrait-of-a-latin-family-with-afro-hair-with-a-7-2025-01-08-03-41-40-utc.jpg";
							}
...
const createHeroAssignment = (asset, alt) => ({
  asset,
  src: asset.src,
  width: asset.width,
  height: asset.height,
...
const supplementalImageKeys = {
  cindyPortrait: "cindyPortrait"
};
...
const createBackgroundAssignment = (asset, description) => ({
  asset,
  src: asset.src,
  width: asset.width,
  height: asset.height,
...
const backgroundImageAssignments = {
...
const allPageData = {
  ...
  "/loan-programs/equity-select": {
    ...
    description: "Access home equity through a flexible first- or second-lien HELOC alternative with predictable payments. EquitySelect supports retirement planning, cash-flow stability, and long-term financial goals.",
...
const cliffmortgagesLogo = new Proxy({"src":"/_astro/cliffmortgages-logo.BI4KuFQI.webp","width":344,"height":46,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/cliffmortgages-logo.webp";
							}
...
const nrmlaLogo = new Proxy({"src":"/_astro/nrmla-logo.D_JTw_VO.png","width":1024,"height":466,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/nrmla-logo.png";
							}
...
const bbbAPlusLogo = new Proxy({"src":"/_astro/bbb-a-plus-logo.B8WTHQjZ.png","width":644,"height":261,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/bbb-a-plus-logo.png";
							}
...
const cindyProfilePic = new Proxy({"src":"/_astro/Cindy_Profile_Pic_200x200.2szno2m9.jpg","width":200,"height":200,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/assets/images/Cindy_Profile_Pic_200x200.jpg";
							}
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const footerColumns = [
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          value: "C2 Financial Corporation is an Equal Housing Opportunity Mortgage Broker/Lender. C2 is not acting on behalf of, or at the direction of, HUD/FHA or the VA. VA loans are offered through C2\u2019s relationships with VA-approved lenders."
        },
        {
          type: "links",
          value: [
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          value: "Cindy Cliff, Mortgage Loan Originator NMLS #2075376 | DRE #100524014 | 970-699-3900"
        },
        {
          type: "tel",
          value: {
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          value: "Colorado-based mortgage services offering home loans throughout Colorado\u2019s key markets: Denver Metro | Boulder | Fort Collins | Loveland | Greeley | Longmont | Colorado Springs | Northern Colorado | The Front Range \u2014 plus referral partnerships through C2 Financial for clients in 29 additional states."
        }
      ]
    }
  ];
  ...
  const disclosureColumns = variant === "landing-page-footer-varient" ? footerColumns.filter((column) => column.title !== "Service Area") : footerColumns;
  return renderTemplate`${maybeRenderHead()}<footer class="bg-gray-900 text-gray-200"> <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12"> ${showLandingVariant ? renderTemplate`<div class="grid grid-cols-1 lg:grid-cols-4 gap-10"> <div class="space-y-4"> <a href="/" class="inline-block footer-logo"> <img${addAttribute(cliffmortgagesLogo.src, "src")} alt="Cliff Mortgages Logo" class="h-10 w-auto rounded-[10px]" width="160" height="40" loading="lazy"> </a> <div class="flex items-center gap-3 text-xs text-gray-300"> <svg class="h-8 w-8 flex-shrink-0 text-white" viewBox="0 0 64 64" role="img" aria-labelledby="equal-housing-title"> <title id="equal-housing-title">
                  Equal Housing Opportunity
                </title> <path fill="currentColor" d="M32 6 4 24v6h6v28h44V30h6v-6L32 6zm16 46H16V30h32v22zm-24-4h16v-6H24v6zm0-10h16v-6H24v6z"></path> </svg> <span class="uppercase tracking-wide">
Equal Housing Opportunity
</span> </div> </div> <div> <h4 class="font-semibold text-white mb-3">Legal</h4> <ul class="space-y-2 text-sm"> ${sitemap.legal.map((link) => renderTemplate`<li> <a${addAttribute(link.path, "href")} class="hover:text-white"> ${link.name} </a> </li>`)} </ul> </div> <div class="space-y-2"> <p class="text-sm leading-relaxed font-semibold text-white/90">
Serving all of Colorado
</p> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <a href="tel:+1970-699-3900" class="text-sm leading-relaxed text-white/90">
Phone: 970-699-3900
</a> <br> ` })} <a href="tel:+1970-308-2540" class="text-sm leading-relaxed text-white/90">
Alt Phone: 970-308-2540
</a> </div> <div class="flex items-start lg:justify-end"> <div class="inline-flex items-center gap-4 bg-white rounded-[10px] p-2.5 w-fit"> <img${addAttribute(nrmlaLogo.src, "src")} alt="National Reverse Mortgage Lenders Association member" class="w-[60px] h-auto object-contain" width="60" height="30" loading="lazy"> <img${addAttribute(bbbAPlusLogo.src, "src")} alt="Better Business Bureau A+ rating" class="w-[60px] h-auto object-contain" width="60" height="30" loading="lazy"> </div> </div> </div>` : renderTemplate`<div class="grid grid-cols-1 lg:grid-cols-4 gap-10"> <div class="space-y-4"> <a href="/" class="inline-block footer-logo"> <img${addAttribute(cliffmortgagesLogo.src, "src")} alt="Cliff Mortgages Logo" class="h-10 w-auto rounded-[10px]" width="160" height="40" loading="lazy"> </a> <div class="flex items-center gap-3 text-xs text-gray-300"> <svg class="h-8 w-8 flex-shrink-0 text-white" viewBox="0 0 64 64" role="img" aria-labelledby="equal-housing-title"> <title id="equal-housing-title">
                  Equal Housing Opportunity
                </title> <path fill="currentColor" d="M32 6 4 24v6h6v28h44V30h6v-6L32 6zm16 46H16V30h32v22zm-24-4h16v-6H24v6zm0-10h16v-6H24v6z"></path> </svg> <span class="uppercase tracking-wide">
Equal Housing Opportunity
</span> </div> <div class="inline-flex items-center gap-4 bg-white rounded-[10px] p-2.5 w-fit"> <img${addAttribute(nrmlaLogo.src, "src")} alt="National Reverse Mortgage Lenders Association member" class="w-[60px] h-auto object-contain" width="60" height="30" loading="lazy"> <img${addAttribute(bbbAPlusLogo.src, "src")} alt="Better Business Bureau A+ rating" class="w-[60px] h-auto object-contain" width="60" height="30" loading="lazy"> </div> </div> <div> <h4 class="font-semibold text-white mb-3">Quick Links</h4> <ul class="space-y-2 text-sm"> ${quickLinks.map((link) => renderTemplate`<li> <a${addAttribute(link.href, "href")} class="hover:text-white"> ${link.label} </a> </li>`)} </ul> </div> <div> <h4 class="font-semibold text-white mb-3">Legal</h4> <ul class="space-y-2 text-sm"> ${sitemap.legal.map((link) => renderTemplate`<li> <a${addAttribute(link.path, "href")} class="hover:text-white"> ${link.name} </a> </li>`)} </ul> <h4 class="font-semibold text-white mt-6 mb-3">Contact</h4> <p class="text-sm leading-relaxed font-semibold text-white/90">
Serving all of Colorado
</p> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <a href="tel:+1970-699-3900" class="text-sm leading-relaxed text-white/90">
Phone: 970-699-3900
</a> <br> ` })} <a href="tel:+1970-308-2540" class="text-sm leading-relaxed text-white/90">
Alt Phone: 970-308-2540
</a> </div> <div class="flex flex-col items-center text-center gap-3"> <img${addAttribute(cindyProfilePic.src, "src")} alt="Cindy Cliff" class="w-1/2 rounded-[200px] object-cover" width="200" height="200" loading="lazy"> <h2 class="text-white font-semibold text-xl">Cindy Cliff</h2> <p class="text-sm text-gray-300 -mt-[10px]">Loan Originator</p> <p class="text-xs text-gray-400">
NMLS #2075376
<br>
DRE #100524014
</p> </div> </div>`} <div class="border-t border-gray-700 pt-10"> <div${addAttribute(`grid grid-cols-1 md:grid-cols-2 ${showLandingVariant ? "lg:grid-cols-3" : "lg:grid-cols-4"} gap-8 text-sm leading-relaxed`, "class")}> ${disclosureColumns.map((column) => renderTemplate`<div class="space-y-3"> <h4 class="text-white font-semibold text-sm uppercase tracking-wide"> ${column.title} </h4> ${column.content.map((item) => {
    if (item.type === "text") {
      return renderTemplate`<p class="text-gray-300 text-xs leading-relaxed"> ${item.value} </p>`;
    }
    if (item.type === "tel") {
      const { prefix, href, label, suffix } = item.value;
      return renderTemplate`<p class="text-gray-300 text-xs leading-relaxed"> ${prefix} <a${addAttribute(href, "href")} class="underline hover:text-white"> ${label} </a> ${suffix} </p>`;
    }
    return renderTemplate`<p class="text-gray-300 text-xs leading-relaxed space-x-2"> ${item.value.map((link, linkIdx) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${linkIdx > 0 && renderTemplate`<span>&nbsp;</span>`}<a${addAttribute(link.href, "href")} class="underline hover:text-white" target="_blank" rel="noopener noreferrer"> ${link.label} </a> ` })}`)} </p>`;
  })} </div>`)} </div> </div> <div class="border-t border-gray-700 pt-6 text-center text-xs text-gray-400 space-y-2"> <p>
C2 Financial Corporation — NMLS #135622. Equal Housing Opportunity. See
        our
<a href="/legal/privacy-policy" class="underline hover:text-white">Privacy Policy</a> ${" "}
and
<a href="/legal/accessibility" class="underline hover:text-white">Accessibility</a> ${" "}pages for details.
</p> <p>Copyright © ${currentYear} Cliff Mortgages. All rights reserved.</p> </div> </div> </footer>`;
}, "/Volumes/14 Tera/Development/Cliff Mortgages/cliff-mortgages-lead-gen-site (astro edition) copy/Astro Site/src/components/Footer.astro", void 0);

export { $$Footer as $, allPageData as a, sitemap as b, backgroundImageAssignments as c, cliffmortgagesLogo as d, heroImageAssignments as h, pageHeroImageKeys as p, supplementalImageKeys as s };
